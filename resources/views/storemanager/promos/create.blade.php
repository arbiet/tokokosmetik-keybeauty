                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('storemanager.promos.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <input id="discount_percentage" type="number" step="0.01" name="discount_percentage" value="{{ old('discount_percentage') }}" required
                        ...
                        <div class="mt-4">
                            ...
                            <input id="maximum_discount" type="number" step="0.01" name="maximum_discount" value="{{ old('maximum_discount') }}" required
