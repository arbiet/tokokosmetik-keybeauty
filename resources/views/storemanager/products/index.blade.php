                        ...
                        <div class="overflow-x-auto">
                            <table class="table-auto w-full">
                                ...
                                <tbody class="text-sm divide-y divide-gray-100">
                                    ...
                                    <tr>
                                        <td class="p-2"><img src="{{ $product->image ? asset('storage/images/products/' . $product->image) : asset('storage/images/products/default.png') }}" alt="Product Image" class="w-8 h-8 object-cover"></td>
